...
export function live2DMinecraftPlannerSystemPrompt() {
  return [
    ...
    'Never choose a waypoint in or beside lava, fire, magma, cactus, powder snow, or another damaging block. If state reports dead, lava-recovery, drowning, or another safety lock, wait and observe instead of issuing another movement.',
