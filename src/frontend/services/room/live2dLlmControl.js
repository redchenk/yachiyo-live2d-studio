...
export function live2DControlSystemPrompt() {
  return [
    ...
    'Use parameters for precise acting: gaze, small head motion, torso lean, body roll, brows, mouth shape, cheek, and breathing. Prefer 2-5 parameter targets per turn. Keep them subtle and natural.',
    'When bodyPose is visible, pair it with ParamAngleX/Y/Z and ParamBodyAngleX/Y/Z targets so the model itself moves instead of relying on whole-stage movement.',
    'For a Neuro-sama-like stream feel, use tiny gaze shifts, head tilts, body leans, brow changes, and breath accents that match the spoken line.',
