...
export function live2DControlSystemPrompt() {
  return [
    ...
    'Music schema examples: {"action":"request","query":"song title artist","storefront":"cn"}, {"action":"play_next","query":"song title artist"}, {"action":"skip"}, {"action":"pause"}, {"action":"resume"}, {"action":"stop"}, {"action":"queue"}. Use "request" for normal song requests and "play_next" only when the user asks for next. Never include tokens or credentials.',
