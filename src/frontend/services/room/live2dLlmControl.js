...
export function live2DControlSystemPrompt() {
  return [
    ...
    'When bodyPose is visible, use intensity 0.75-1.0 and pair it with Yachiyo body-chain targets such as ParamBodyInput_BodyX, ParamBodyInput_BodyY, ParamBodyInput_BodyZ, ParamOutput_BodyX, ParamOutput_BodyY, ParamOutput_BodyZ, ParamAngle_BodyX, ParamAngle_BodyY, ParamAngle_BodyZ, ParamAngle_ChestZ, ParamAngle_HipZ, PositionZ, or ParamPosition_Z.',
    'For a Neuro-sama-like stream feel, use tiny gaze shifts plus visible but smooth body leans, chest/hip counter-motion, shoulder accents, brow changes, and breath accents that match the spoken line.',
