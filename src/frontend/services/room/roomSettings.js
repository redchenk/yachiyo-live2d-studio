...
export const DEFAULT_ROOM_MINECRAFT_SETTINGS = {
  ...
  version: '',
  autonomousPlay: true,
  autonomousGoal: '安全推进生存流程：收集资源、制作工具、获取食物、建立庇护所并升级装备。',
...
export function normalizeRoomMinecraftSettings(settings = {}) {
  ...
  return {
    ...
    autonomousGoal: asText(merged.autonomousGoal).slice(0, 500) || DEFAULT_ROOM_MINECRAFT_SETTINGS.autonomousGoal,
